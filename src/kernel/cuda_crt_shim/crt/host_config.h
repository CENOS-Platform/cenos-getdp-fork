...
//
// This file is NOT GetDP source: it's NVIDIA's own crt/host_config.h from the CUDA
...
// include/host_config.h is only a deprecation-forwarding stub that itself does
// "#include \"crt/host_config.h\"", expecting to find the real file here - which
